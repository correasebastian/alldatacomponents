...
module.exports = yeoman.Base.extend({
  ...
  prompting: function() {
    ...
    this.log(yosay(
      'Welcome to the ' + chalk.red('fractal-component') + ' generator! \nI create stub files for new fractal components.'
    ));
    ...
    this.prompt(prompts).then(function(props) {
      ...
      this.props.folderName = this.props.folder + '/' + this.props.componentNameDashed;
      ...
      // if (this.props.modeSet.has('htl')) {
        ...
        this.props.twigTemplateName = 'render' + capitalizeFirstLetter(this.props.componentNameCamel);
        this.log('twigName:\t\t' + chalk.blue(this.props.twigName));
        this.log('twigTemplateName:\t' + chalk.blue(this.props.twigTemplateName));
      // }
  ...
  writing: function() {
    ...
    // if (this.props.modeSet.has('js')) {
      ...
      var jsToAdd = 'import \'../../components/' +  this.props.folderName + '/' + this.props.jsFileName + '\';\n';
    ...
    // if (this.props.modeSet.has('htl')) {
      this.fs.copyTpl(
        ...
        this.destinationPath(path.join(componentDir, this.props.folderName, this.props.twigName + '.twig')),
        this.props
      );
    // }
    ...
    // if (this.props.modeSet.has('htl')) {
      this.fs.copyTpl(
        ...
        this.destinationPath(path.join(componentDir, this.props.folderName, this.props.twigName + '.config.json')),
        this.props
      );
    // }
